...
class GymEnv(object):
    ...
    def visualize_policy_offscreen(
        ...
        return self.env.env.visualize_policy_offscreen(
            policy, horizon, num_episodes, frame_size,
            mode, save_loc, filename, camera_name
        )
    ...
    def visualize_policy_frames(
        ...
        return self.env.env.visualize_policy_frames(
            policy, horizon, num_episodes, frame_size,
            mode, save_loc, filename, camera_name
        )

    def record_demos(self, policy, horizon=1000, num_episodes=1, mode='exploration'):
        return self.env.env.record_demos(policy, horizon, num_episodes, mode)
